...
def default_config() -> dict:
    return {
        ...
        "styles": {
            ...
            "h1": style("Heading 1 Custom", "SimHei", "Times New Roman", 14, True, "left", 1.0, 0, 0, 0, ui_priority=10, outline_level=0, keep_next=True, keep_lines=True),
            "h2": style("Heading 2 Custom", "SimSun", "Times New Roman", 12, False, "left", 1.0, 0, 0, 0, ui_priority=20, outline_level=1, keep_next=True, keep_lines=True),
            "h3": style("Heading 3 Custom", "SimSun", "Times New Roman", 12, False, "left", 1.0, 0, 0, 0, ui_priority=30, outline_level=2, keep_next=True, keep_lines=True),
